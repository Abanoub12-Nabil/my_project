...
class PsalmsQuestionsPage extends StatefulWidget {
  const PsalmsQuestionsPage({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _PsalmsQuestionsPageState createState() => _PsalmsQuestionsPageState();
}

class _PsalmsQuestionsPageState extends State<PsalmsQuestionsPage> {
  String _searchQuery = '';
  ...
  Widget build(BuildContext context) {
    ...
    final filteredChapters = QuestionsData.psalmsQuestions.keys
        .where((chapter) => chapter.toString().contains(_searchQuery))
        .toList();

    return Scaffold(
      appBar: AppBar(
        title: const Text('أسئلة سفر المزامير'),
        actions: [
          IconButton(
          ...
          child: Padding(
            ...
            child: TextField(
              ...
              decoration: const InputDecoration(
                hintText: 'ابحث عن مزمور بالأرقام...',
      ...
      body: filteredChapters.isEmpty
        ...
        children: filteredChapters.map((chapter) {
          final questionCount =
              QuestionsData.psalmsQuestions[chapter]?.length ??
                  0; // عدد الأسئلة
          return ListTile(
            ...
            title: Text(
              'المزمور $chapter ($questionCount سؤال)',
              style: TextStyle(
                  ...
                  pageBuilder: (context, animation, secondaryAnimation) {
                    ...
                    return SlideTransition(
                      ...
                      child: ChapterQuestionsPage(
                        chapter: chapter,
                        questions:
                        QuestionsData.psalmsQuestions[chapter]!,
                      ),
                    );
                  },
                ),
